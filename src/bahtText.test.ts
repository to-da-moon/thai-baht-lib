...
describe('string', () => {
  test('should convert number in string format', () => {
    ...
    // expect(bahtText(('4123001998830750501' as unknown) as number)).toBe(
    ...
    // );
    // expect(bahtText(('-4123001998830750501.21' as unknown) as number)).toBe(
    ...
    // );
    // expect(bahtText(('-1654321.21' as unknown) as number)).toBe(
